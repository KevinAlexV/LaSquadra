...
UIElement::UIElement(float scaleX, float scaleY, float z, int textureListIndex):Drawable(textureListIndex, 4, 4, 4, 6)
{
...
bool UIElement::loadVertices(void* info)
{
    ...
    float cubeVerts[] =
    {
        -1.0f * xScale, -1.0f * yScale, zPos, // Lower left corner
        1.0f * xScale, 1.0f * yScale, zPos, //Upper right corner
        -1.0f * xScale, 1.0f * yScale, zPos, // Upper left corner
        1.0f * xScale, -1.0f * yScale, zPos, //lower right corner
    };
